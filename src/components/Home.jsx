                ...
                <div className="text-center space-y-5 flex flex-col items-center text-accent mt-50 relative z-40">
                    ...
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.8 }}>
                        ...
                        <a href='tel:+380673095451' className='flex gap-x-2 py-3 items-center px-6 rounded-full cursor-pointer bg-accent text-main hover:bg-main hover:text-accent duration-200'><Mail />Connect with me</a>
                            <a href="https://drive.google.com/file/d/1W3Z5CSMc3h_Ynbu1DnihSp0-i-HcSjUF/view?usp=sharing" className='py-3 px-6 border rounded-full border-grey-line' target='_blank'>My resume</a>
                    </div>
                    </motion.div>
                </div>
